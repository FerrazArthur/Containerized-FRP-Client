...
```
cd existing_repo
git remote add origin https://gitlab.quant1.com.br/arthur/q1-frpc.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.quant1.com.br/arthur/q1-frpc/-/settings/integrations)
